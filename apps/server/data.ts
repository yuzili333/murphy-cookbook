...
const curatedRecipeCatalog: RecipeDetail[] = [
  ...
  },
  {
    id: 'recipe_003',
    name: '凉拌手撕鸡',
    namePinyin: 'liáng bàn shǒu sī jī',
    imageUrl: buildRecipeImageUrl('凉拌手撕鸡', undefined, ['鸡肉', '黄瓜']),
    englishName: 'Cold Shredded Chicken Salad',
    nameLearning: {
      characters: [
        { character: '凉', pinyin: 'liáng', strokes: 10, structure: '左右结构', hint: '两点水表示和温度、冰凉有关。' },
        { character: '拌', pinyin: 'bàn', strokes: 8, structure: '左右结构', hint: '提手旁表示用手搅一搅。' },
    ...
    fitReasons: ['已配置烹饪视频', '鸡肉做法清爽', '适合孩子参与手撕和拌匀'],
    riskAlerts: ['鸡肉必须由家长确认完全煮熟后再撕拌', '撕鸡肉前要放到温热不烫手'],
    nutritionSummary: '鸡肉提供优质蛋白，搭配清爽蔬菜，适合儿童轻食或正餐配菜。',
    extraIngredients: [],
    canCookWithCurrentIngredients: true,
    prepTimeMinutes: 8,
    cookTimeMinutes: 10,
    ingredients: [
      { name: '鸡肉', quantity: '100克', imageUrl: buildIngredientImageUrl('鸡肉') },
      { name: '黄瓜', quantity: '半根', imageUrl: buildIngredientImageUrl('黄瓜') },
    ],
    steps: [
      {
        id: 'step_1',
        title: '洗净鸡肉',
        description: '本步骤食材：鸡肉；操作：把鸡肉冲洗干净，放进冷水锅里。家长确认锅放稳后再开火。水面要没过鸡肉。',
        tip: '处理生鸡肉后要及时洗手和清洁案板。',
        riskLevel: 'medium',
        requiresParentAssist: true,
        childAction: '递冷水和干净盘子。',
        parentAction: '处理生鸡肉并开火。',
        expectedResult: '鸡肉入锅准备煮熟。',
      },
      {
        id: 'step_2',
        title: '煮熟放温',
        description: '本步骤食材：鸡肉；操作：家长把鸡肉煮到完全变白熟透，再关火捞出。放到温热不烫手后，确认中间没有粉色。这样才适合手撕。',
        tip: '鸡肉必须熟透，不能夹生。',
        riskLevel: 'high',
        requiresParentAssist: true,
        childAction: '站远观察颜色变化。',
        parentAction: '煮熟、捞出并检查熟度。',
        expectedResult: '鸡肉熟透并放到温热。',
      },
      {
        id: 'step_3',
        title: '撕成细丝',
        description: '本步骤食材：鸡肉；操作：把温热的鸡肉顺着纹理撕成细丝。粗细尽量接近，放进干净大碗里。撕不动的地方请家长帮忙。',
        tip: '顺着纹理撕会更省力。',
        riskLevel: 'low',
        requiresParentAssist: false,
        childAction: '把鸡肉撕成细丝。',
        parentAction: '在旁边看护并处理较硬部分。',
        expectedResult: '鸡肉变成容易入口的细丝。',
      },
      {
        id: 'step_4',
        title: '切黄瓜丝',
        description: '本步骤食材：黄瓜；操作：把黄瓜洗净后切成细丝，放到鸡肉旁边。黄瓜丝不要太长，方便小朋友夹取。切好后一起放入碗中。',
        tip: '切黄瓜时手指要离刀刃远一点。',
        riskLevel: 'medium',
        requiresParentAssist: true,
        childAction: '清洗黄瓜并摆盘。',
        parentAction: '切黄瓜丝。',
        expectedResult: '黄瓜丝准备好。',
      },
      {
        id: 'step_5',
        title: '拌匀装盘',
        description: '本步骤食材：鸡肉、黄瓜；操作：用筷子把鸡肉丝和黄瓜丝轻轻拌匀。拌好后装进盘子里，先少量尝一口确认口感。清爽的手撕鸡就做好了。',
        tip: '拌的时候从碗底往上翻，食材更均匀。',
        riskLevel: 'low',
        requiresParentAssist: false,
        childAction: '轻轻拌匀并摆盘。',
        parentAction: '确认鸡肉温度和入口大小。',
        expectedResult: '完成凉拌手撕鸡',
      },
    ],
  },
];
